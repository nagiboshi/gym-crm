...
@Component({
  ...
  templateUrl: './membership-purchase-form.component.html',
  styleUrls: ['./membership-purchase-form.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class MembershipPurchaseFormComponent implements OnInit {
  ...
  constructor(private dialogRef: MatDialogRef<MembershipPurchaseFormComponent>,
